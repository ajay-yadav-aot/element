...
describe('NewCarousel', () => {
  ...
  it('create', () => {
    vm = createVue({
      template: `
        <div>
          <el-new-carousel ref="carousel">
            <el-new-carousel-item v-for="item in 3" :key="item"></el-new-carousel-item>
          </el-new-carousel>
        </div>
      `
    });
  ...
  it('initial index', done => {
    vm = createVue({
      template: `
        <div>
          <el-new-carousel :autoplay="false" :initial-index="1">
            <el-new-carousel-item v-for="item in 3" :key="item"></el-new-carousel-item>
          </el-new-carousel>
        </div>
      `
  ...
  it('change', done => {
    vm = createVue({
      template: `
        <div>
          <el-new-carousel :interval="50" @change="handleChange">
            <el-new-carousel-item v-for="item in 3" :key="item"></el-new-carousel-item>
          </el-new-carousel>
        </div>
      `,
  ...
  it('label', done => {
    vm = createVue({
      template: `
        <div>
          <el-new-carousel>
            <el-new-carousel-item v-for="item in 3" :key="item" :label="item"></el-new-carousel-item>
          </el-new-carousel>
        </div>
      `
    });
  ...
  describe('manual control', () => {
    it('hover', done => {
      vm = createVue({
        template: `
        <div>
          <el-new-carousel :autoplay="false">
            <el-new-carousel-item v-for="item in 3" :key="item"></el-new-carousel-item>
          </el-new-carousel>
        </div>
      `
    ...
    it('click', done => {
      vm = createVue({
        template: `
        <div>
          <el-new-carousel :autoplay="false" trigger="click" ref="carousel">
            <el-new-carousel-item v-for="item in 3" :key="item"></el-new-carousel-item>
          </el-new-carousel>
        </div>
      `
  ...
  it('card', done => {
    vm = createVue({
      template: `
        <div>
          <el-new-carousel :autoplay="false" type="card">
            <el-new-carousel-item v-for="item in 7" :key="item"></el-new-carousel-item>
          </el-new-carousel>
        </div>
      `
    });
  ...
  it('vertical direction', () => {
    vm = createVue({
      template: `
        <div>
          <el-new-carousel ref="carousel" :autoplay="false" direction="vertical" height="100px">
            <el-new-carousel-item v-for="item in 3" :key="item"></el-new-carousel-item>
          </el-new-carousel>
        </div>
      `
